...
- [ ] 1. 为 hello-claude-code 项目创建合并章节
  - [x] 1.1 读取并合并三个源章节内容
...
- [ ] 2. 为 hello-codex 项目创建合并章节
  ...
  - [ ] 2.2 创建新的 04-state-session-memory.md 文件
    - 使用中文编写内容
    - 设置 YAML front matter: `layout: content`, `title: "Codex 的状态、会话与记忆系统"`
    - _Requirements: 1.1, 6.1, 6.2, 8.1, 8.2_

- [ ] 3. 为 hello-gemini-cli 项目创建合并章节
  - [ ] 3.1 读取并合并三个源章节内容
  ...
  - [ ] 3.2 创建新的 04-state-session-memory.md 文件
    - 使用中文编写内容
    - 设置 YAML front matter: `layout: content`, `title: "Gemini CLI 的状态、会话与记忆系统"`
    - _Requirements: 1.1, 6.1, 6.2, 8.1, 8.2_

- [ ] 4. 为 hello-opencode 项目创建合并章节
  - [ ] 4.1 读取并合并三个源章节内容
  ...
  - [ ] 4.2 创建新的 04-state-session-memory.md 文件
    - 使用中文编写内容
    - 设置 YAML front matter: `layout: content`, `title: "OpenCode 的状态、会话与记忆系统"`
    - _Requirements: 1.1, 6.1, 6.2, 8.1, 8.2_

- [ ] 5. Checkpoint - 验证新章节创建完成
  - 确认所有四个项目都有新的 04-state-session-memory.md 文件
  - 验证内容完整性和中文语言一致性
  - 询问用户是否有问题

- [ ] 6. 重新编号 hello-claude-code 项目的章节
  - [ ] 6.1 重命名 04-tool-system.md 为 05-tool-system.md
    - 使用 `git mv` 命令保留历史记录
    - _Requirements: 3.1_
  
  - [ ] 6.2 重命名 12-15 章节为 11-14
...
- [ ] 7. 重新编号 hello-codex 项目的章节
  - [ ] 7.1 重命名 04-tool-system.md 为 05-tool-system.md
    - _Requirements: 3.1_
  
  - [ ] 7.2 重命名 12-15 章节为 11-14
    - _Requirements: 3.3_
...
- [ ] 8. 重新编号 hello-gemini-cli 项目的章节
  - [ ] 8.1 重命名 04-tool-system.md 为 05-tool-system.md
    - _Requirements: 3.1_
  
  - [ ] 8.2 重命名 12-15 章节为 11-14
    - _Requirements: 3.3_
  
  - [ ] 8.3 重命名 17+ 章节为 15+
    - _Requirements: 3.4_

- [ ] 9. 重新编号 hello-opencode 项目的章节
  - [ ] 9.1 重命名 04-tool-system.md 为 05-tool-system.md
    - _Requirements: 3.1_
  
  - [ ] 9.2 重命名 12-15 章节为 11-14
    - _Requirements: 3.3_
  
  - [ ] 9.3 重命名 17+ 章节为 15+
    - _Requirements: 3.4_

- [ ] 10. Checkpoint - 验证章节重编号完成
  - 确认所有四个项目的章节编号正确
  - 验证没有遗漏的文件
  - 询问用户是否有问题

- [ ] 11. 更新 hello-claude-code 项目的内部引用
  - [ ] 11.1 扫描所有 Markdown 文件中的链接
  ...
  - [ ] 11.4 更新 index.md 或 README.md 中的章节列表
    - 如果存在章节索引，更新章节编号和标题
    - _Requirements: 4.5_

- [ ] 12. 更新 hello-codex 项目的内部引用
  - [ ] 12.1 扫描并更新指向已删除章节的链接
    - _Requirements: 4.1, 4.2, 4.3_
  
  - [ ] 12.2 更新指向已重命名章节的链接
    - _Requirements: 4.2, 4.4_
  
  - [ ] 12.3 更新 index.md 或 README.md 中的章节列表
    - _Requirements: 4.5_

- [ ] 13. 更新 hello-gemini-cli 项目的内部引用
  - [ ] 13.1 扫描并更新指向已删除章节的链接
    - _Requirements: 4.1, 4.2, 4.3_
  
  - [ ] 13.2 更新指向已重命名章节的链接
    - _Requirements: 4.2, 4.4_
  
  - [ ] 13.3 更新 index.md 或 README.md 中的章节列表
    - _Requirements: 4.5_

- [ ] 14. 更新 hello-opencode 项目的内部引用
  - [ ] 14.1 扫描并更新指向已删除章节的链接
    - _Requirements: 4.1, 4.2, 4.3_
  
  - [ ] 14.2 更新指向已重命名章节的链接
    - _Requirements: 4.2, 4.4_
  
  - [ ] 14.3 更新 index.md 或 README.md 中的章节列表
    - _Requirements: 4.5_

- [ ] 15. Checkpoint - 验证内部引用更新完成
  - 运行链接检查工具验证没有断链
  - 询问用户是否有问题

- [ ] 16. 更新 hello-harness 横向对比分析
  - [ ] 16.1 更新 hello-harness/06-context-and-memory.md
...
- [ ] 17. 删除原有章节文件
  - [ ] 17.1 删除 hello-claude-code 的旧章节
...
- [ ] 19. 验证 Jekyll 构建
  ...
  - [ ] 19.3 验证 YAML front matter
    - 确认所有新文件和重命名文件的 front matter 正确
    - 验证 title 字段反映新的章节名称
    - _Requirements: 8.1, 8.2, 8.3_

- [ ] 20. Final checkpoint - 完成验证和清理
  - 确认所有任务完成
  - 生成最终验证报告
  - 询问用户是否需要调整或有其他问题
