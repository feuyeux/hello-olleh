...
| API system blocks | `sources/claude-code/src/services/api/claude.ts:1377`, `sources/claude-code/src/utils/api.ts:3214` | Anthropic system text blocks | 在发送前加 cache_control，并应用 system prompt prefix splitting |
...
| `buildSystemPromptBlocks()` | `sources/claude-code/src/utils/api.ts:3214` | 将 system prompt 分块并加 `cache_control` |
