...
Codex 是四个工程中层次最分明的。整条执行链在 `sources/codex/codex-rs/core/src/codex.rs` 中分为四层：
...
**位置** — `sources/codex/codex-rs/core/src/codex.rs:4289-4475`
...
**位置** — `sources/codex/codex-rs/core/src/codex.rs:5584-6052`
...
**位置** — `sources/codex/codex-rs/core/src/codex.rs:6363-6510`
...
**位置** — `sources/codex/codex-rs/core/src/codex.rs:7176-7450`
...
**位置** — `sources/gemini-cli/packages/core/src/core/client.ts:1426`
...
**位置** — `sources/gemini-cli/packages/core/src/core/client.ts:563`
...
**位置** — `sources/gemini-cli/packages/core/src/core/turn.ts:253-340`
...
**位置** — `sources/gemini-cli/packages/cli/src/ui/hooks/useGeminiStream.ts:1724-1858`
