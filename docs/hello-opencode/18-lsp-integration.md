...
源码上，`sources/opencode/packages/opencode/src/lsp/index.ts:87`、`sources/opencode/packages/opencode/src/lsp/index.ts:89` 维护禁用/损坏集合，`sources/opencode/packages/opencode/src/tool/read.ts:216` 只是在读取后触碰 LSP，`sources/opencode/packages/opencode/src/tool/write.ts:55` 到 `sources/opencode/packages/opencode/src/tool/write.ts:77`、`sources/opencode/packages/opencode/src/tool/apply_patch.ts:234` 到 `sources/opencode/packages/opencode/src/tool/apply_patch.ts:276` 把 diagnostics 作为输出附加段处理。这个边界说明 LSP 失败不会破坏 durable message，只会减少模型可见的代码理解信号。
