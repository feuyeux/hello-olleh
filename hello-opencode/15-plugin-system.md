...
本文是 plugin 系统深挖，适合在读完当前承载“扩展面”主题的 [23-bridge-system.md](./23-bridge-system.md) 之后继续深究。
...
如果把本文放回主线里理解，可以把它看成 [19-settings-config.md](./19-settings-config.md) 的启动时机补充，以及 [23-bridge-system.md](./23-bridge-system.md) 的 plugin 细化稿。
